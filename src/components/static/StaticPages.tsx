      ...
      {pageType === 'about' && (
        <div className="space-y-8">
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none text-slate-700 dark:text-slate-300 text-sm leading-relaxed space-y-6">
            ...
            <p>
              DevPulse is built using React 19, TypeScript, and modern browser APIs including the Web Crypto API, HTML5 Canvas, and modern ECMAScript standards. It compiles into a static asset tree ready for global edge deployment on platforms like Cloudflare Pages, GitHub Pages, or any static web host.
            </p>
          </div>
        </div>
      )}
      ...
      {pageType === 'terms' && (
        <div className="space-y-8">
          ...
          <div className="space-y-6 text-sm text-slate-700 dark:text-slate-300 leading-relaxed">
            ...
            <p>
              All 20 tools provided on DevPulse are 100% free for both personal and commercial use. You may use them to format documents, verify security tokens, compress media assets, and generate code without payment or attribution requirements.
            </p>
