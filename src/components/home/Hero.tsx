        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 max-w-3xl mx-auto mt-10 pt-8 border-t border-slate-200/80 dark:border-slate-800/80 text-left">
          <div className="flex items-center gap-2.5 p-2 rounded-xl">
            ...
            <div>
              ...
              <div className="text-[11px] text-slate-500 dark:text-slate-400">No server processing</div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2.5 p-2 rounded-xl">
            ...
            <div>
              <div className="text-xs font-bold text-slate-900 dark:text-white">Zero Latency</div>
              <div className="text-[11px] text-slate-500 dark:text-slate-400">Instant memory execution</div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2.5 p-2 rounded-xl">
            ...
            <div>
              ...
              <div className="text-[11px] text-slate-500 dark:text-slate-400">Never saved or sold</div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2.5 p-2 rounded-xl">
            ...
            <div>
              ...
              <div className="text-[11px] text-slate-500 dark:text-slate-400">No limits or signup</div>
            </div>
          </div>
        </div>
      </div>
