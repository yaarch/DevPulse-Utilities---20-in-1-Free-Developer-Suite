...
export const TRANSLATIONS: Record<Language, TranslationDict> = {
  en: {
    ...
    appTagline: '40-in-1 Free Developer & User Utility Suite',
    ...
    heroDescription: 'Experience 40 high-performance utility tools with uncompromising privacy. All operations execute strictly on your device with zero data sent to external servers.',
    searchPlaceholder: 'Search 40+ tools (e.g. JSON, Base64, QR, Regex, SQL, Flexbox, Cron)...',
    ...
    toolsCountBadge: '40 Essential Tools',
  ...
  es: {
    ...
    appTagline: 'Suite de 40 herramientas gratuitas para desarrolladores',
    ...
    heroDescription: 'Disfruta de 40 herramientas de alto rendimiento con total privacidad. Todos los procesos se ejecutan localmente sin enviar datos a servidores externos.',
    ...
    toolsCountBadge: '40 Herramientas Esenciales',
  ...
  fr: {
    ...
    appTagline: 'Suite 40-en-1 gratuite pour développeurs et créateurs',
    ...
    heroDescription: 'Profitez de 40 utilitaires haute performance avec une confidentialité sans compromis. Tous les traitements s\'exécutent localement.',
    searchPlaceholder: 'Rechercher 40+ outils (ex. JSON, Base64, QR, Regex, SQL, Flexbox)...',
    ...
    toolsCountBadge: '40 Outils Utiles',
  ...
  ar: {
    ...
    appTagline: 'مجموعة متكاملة تضم 40 أداة مجانية للمطورين والمصممين',
    ...
    heroDescription: 'استمتع بأفضل 40 أداة متطورة مع حماية قصوى لخصوصيتك. تتم جميع العمليات محلياً على جهازك دون إرسال أي بيانات لخوادم خارجية.',
    searchPlaceholder: 'ابحث بين أكثر من 40 أداة (مثال: JSON, Base64, QR, Regex, SQL)...',
    ...
    toolsCountBadge: '٤٠ أداة برمجية أساسية',
  ...
  de: {
    ...
    appTagline: '40-in-1 Kostenlose Entwickler- & Benutzer-Tools',
    ...
    heroDescription: 'Erleben Sie 40 leistungsstarke Online-Tools mit kompromissloser Privatsphäre. Alle Berechnungen laufen lokal auf Ihrem Gerät ohne Datenübertragung.',
    searchPlaceholder: '40+ Werkzeuge durchsuchen (z. B. JSON, Base64, QR, Regex, SQL)...',
    ...
    toolsCountBadge: '40 Wichtige Tools',
