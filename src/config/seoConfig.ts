...
export const STATIC_PAGES_SEO: Record<string, { title: string; metaDescription: string; h1: string; canonical: string }> = {
  ...
  'deploy-guide': {
    title: 'Cloudflare Pages Deployment Guide – DevPulse Tools',
    metaDescription: 'Step-by-step instructions for deploying DevPulse Tools to Cloudflare Pages with zero-config SPA routing and global edge CDN caching.',
    h1: 'Deploying to Cloudflare Pages',
    canonical: `${SITE_URL}/deploy-guide/`
  },
  'not-found': {
    title: '404 - Page Not Found | DevPulse Tools',
    metaDescription: 'The page you requested could not be found. Explore our 20 free developer tools or return to the DevPulse homepage.',
